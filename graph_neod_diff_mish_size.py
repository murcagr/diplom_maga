...
path = "/home/remini/learning/diplom_diff_misheh_size"
res = []
for filename in os.listdir(path):
    if re.match("table_ne*", filename):
        with open(os.path.join(path, filename), 'r') as f:
            ...
            r0 = float(filename_s[7][4:])
            r1 = float(filename_s[8].split(".")[0][5:])
            # if r0 + r1 >= 30:
            #     continue
...
plt.xlabel("Высота мишени (см)")
plt.ylabel("Ширина мишени (см)")
